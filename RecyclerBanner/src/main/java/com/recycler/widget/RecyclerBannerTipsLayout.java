 ...
 * by y on 2016/10/25
 */
class RecyclerBannerTipsLayout extends RelativeLayout {

    private TextView textView = null;
    private LinearLayout linearLayout = null;

    public RecyclerBannerTipsLayout(Context context) {
        super(context);
    }

    public RecyclerBannerTipsLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RecyclerBannerTipsLayout(Context context, AttributeSet attrs, int defStyleAttr) {
