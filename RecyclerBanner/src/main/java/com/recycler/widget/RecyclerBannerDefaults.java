...
class RecyclerBannerDefaults {
     ...
     */
    static final int TIPS_LAYOUT_WIDTH = RecyclerBannerLayout.MATCH_PARENT;
    /**
     ...
     */
    static final int TITLE_WIDTH = RecyclerBannerLayout.WRAP_CONTENT;
    /**
     * The height of the default title
     */
    static final int TITLE_HEIGHT = RecyclerBannerLayout.WRAP_CONTENT;
    /**
